      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl shadow-xl p-8 animate-scale-in border border-gray-800">
          <div className="flex justify-center mb-6">
             <Image src='/logo/KDA-logo-white.png' alt='KDS Logo' width={150} height={100} priority />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="bg-gray-800/50 text-white border-gray-700 focus:border-primary focus:ring-primary h-11"
              />
            </div>
            ...
            <Button
              type="submit"
              className="w-full bg-primary text-white hover:opacity-90 h-11 font-semibold transition-all mt-2"
              disabled={isLoading}
            >
