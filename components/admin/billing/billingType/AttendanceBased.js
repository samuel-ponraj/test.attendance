...
const AttendanceBased = ({
	...
	if (billingCycle === "daily") {
		return <Daily teamId={teamId} team={team} members={members} initialMemberId={initialMemberId} showBackButton={showBackButton} />;
	}

	if (billingCycle === "monthly") {
		return <Monthly teamId={teamId} team={team} members={members} initialMemberId={initialMemberId} showBackButton={showBackButton} />;
	}
