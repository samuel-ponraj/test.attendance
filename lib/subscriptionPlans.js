...
export const getBillingOption = (plan, billingCycle = BILLING_CYCLES.MONTHLY) =>
  plan?.billingOptions?.find((option) => option.id === billingCycle) ||
